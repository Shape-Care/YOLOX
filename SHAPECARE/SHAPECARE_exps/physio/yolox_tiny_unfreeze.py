#!/usr/bin/env python3
# -*- coding:utf-8 -*-
# SHAPECARE — Physio (general base) — YOLOX-tiny — FAZA 2: pełny fine-tuning
#
#   python tools/train.py \
#       -f SHAPECARE/SHAPECARE_exps/physio/yolox_tiny_unfreeze.py \
#       -c YOLOX_outputs/yolox_tiny_freeze/best_ckpt.pth \
...
class Exp(MyExp):
    def __init__(self):
        ...
        self.max_epoch = 100
        self.basic_lr_per_img = 0.00001 / 64
