#!/usr/bin/env python3
# -*- coding:utf-8 -*-
# SHAPECARE — Physio (general base) — YOLOX-tiny — FAZA 1: zamrożony backbone
#
# Baza (podaj przez -c):  /shared/shapecare-models/yolox_tiny_miap_levi_1.pth
# Dataset: SHAPECARE/data/Physio  (klasa Person, poprawione boxy CVAT; 4079 train / 441 val)
#
#   python tools/train.py \
#       -f SHAPECARE/SHAPECARE_exps/physio/yolox_tiny_freeze.py \
...
class Exp(MyExp):
    def __init__(self):
        ...
        self.mixup_prob = 0.0
        self.random_size = (10, 20)        # tiny — skalowanie wokół 416
