#!/usr/bin/env python3
# -*- coding:utf-8 -*-
# SHAPECARE — InteractiveSport mixed — YOLOX-s — FAZA 2: pełny fine-tuning
#
# Resume from the matching FAZA-1 run (keep the -expn consistent per base):
#   python tools/train.py -f SHAPECARE/SHAPECARE_exps/interactive-mixed/yolox_s_interactive_unfreeze.py \
#       -c YOLOX_outputs/is_s_from_miap_freeze/best_ckpt.pth \
#       -expn is_s_from_miap_unfreeze --resume --fp16 -d 1 -b 16 -o -l mlflow
