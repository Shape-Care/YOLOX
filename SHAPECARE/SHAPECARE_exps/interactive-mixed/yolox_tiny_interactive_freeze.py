#!/usr/bin/env python3
# -*- coding:utf-8 -*-
# SHAPECARE — InteractiveSport mixed (brzesko + squash + podleze) — YOLOX-tiny — FAZA 1
#
...
#   python tools/train.py -f SHAPECARE/SHAPECARE_exps/interactive-mixed/yolox_tiny_interactive_freeze.py \
#       -c /shared/shapecare-models/yolox_tiny_miap_levi_1.pth \
#       -expn is_tiny_from_miap_freeze --fp16 -d 1 -b 16 -o -l mlflow
#   # from the physio general base:
#   python tools/train.py -f SHAPECARE/SHAPECARE_exps/interactive-mixed/yolox_tiny_interactive_freeze.py \
#       -c YOLOX_outputs/yolox_tiny_unfreeze/best_ckpt.pth \
#       -expn is_tiny_from_physio_freeze --fp16 -d 1 -b 16 -o -l mlflow
